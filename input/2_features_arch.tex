...
of the wall-clock cost of this stacks replicated statevector design vs implementations that have distributed statevector simulation. 
% THERE ARE MORE DETAILS TO BE ADDED HERE
The comparison is reported with a single seeds rather than the $n{=}5$ methodology otherwise used in this stack. 
