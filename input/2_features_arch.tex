...
classical-quantum components, the stack allows ranks to remain active and begin local computation of the statevector expectation values while still
waiting for the circuit results from the cloud QPU. Once worker ranks receive the expectation values, they 
...
the A100 (2039 GB/s) would provide a significantly faster speedup over the results obtained within this stack.
