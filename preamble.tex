...
\usepackage{amsmath}              % math text helpers such as \text in equations
\usepackage[numbers]{natbib}       % numeric citations; defines \citep and \citet
\newcommand{\parencite}[1]{\citep{#1}} % compatibility alias for existing citations
\newcommand{\textcite}[1]{\citet{#1}} % compatibility alias for existing citations
...
% Ensure there is enough margin width for todonotes to render correctly in two-column layouts
